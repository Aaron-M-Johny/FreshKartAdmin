...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Grocery: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.GroceryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.GroceryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type GroceryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "Brand" | "Category" | "DiscountPrice" | "Image_Url" | "Price" | "ProductName" | "Quantity" | "Stock" | "SubCategory", ExtArgs["result"]["grocery"]>
  ...
  export interface GroceryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Groceries that matches the filter.
     * @param {GroceryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const grocery = await prisma.grocery.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: GroceryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Grocery.
     * @param {GroceryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const grocery = await prisma.grocery.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: GroceryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface GroceryFieldRefs {
    ...
    readonly Brand: FieldRef<"Grocery", 'String'>
    readonly Category: FieldRef<"Grocery", 'String'>
    readonly DiscountPrice: FieldRef<"Grocery", 'Float'>
    readonly Image_Url: FieldRef<"Grocery", 'String'>
    readonly Price: FieldRef<"Grocery", 'Float'>
    readonly ProductName: FieldRef<"Grocery", 'String'>
    readonly Quantity: FieldRef<"Grocery", 'String'>
    readonly Stock: FieldRef<"Grocery", 'Int'>
    readonly SubCategory: FieldRef<"Grocery", 'String'>
  }
   ...
   * Grocery findRaw
   */
  export type GroceryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Grocery aggregateRaw
   */
  export type GroceryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type GroceryWhereInput = {
    ...
    Brand?: StringFilter<"Grocery"> | string
    Category?: StringFilter<"Grocery"> | string
    DiscountPrice?: FloatFilter<"Grocery"> | number
    Image_Url?: StringFilter<"Grocery"> | string
    Price?: FloatFilter<"Grocery"> | number
    ProductName?: StringFilter<"Grocery"> | string
    Quantity?: StringFilter<"Grocery"> | string
    Stock?: IntFilter<"Grocery"> | number
    SubCategory?: StringFilter<"Grocery"> | string
  }
  ...
  export type GroceryOrderByWithAggregationInput = {
    ...
    _avg?: GroceryAvgOrderByAggregateInput
    _max?: GroceryMaxOrderByAggregateInput
    _min?: GroceryMinOrderByAggregateInput
    _sum?: GrocerySumOrderByAggregateInput
  }
  ...
  export type GroceryScalarWhereWithAggregatesInput = {
    ...
    Brand?: StringWithAggregatesFilter<"Grocery"> | string
    Category?: StringWithAggregatesFilter<"Grocery"> | string
    DiscountPrice?: FloatWithAggregatesFilter<"Grocery"> | number
    Image_Url?: StringWithAggregatesFilter<"Grocery"> | string
    Price?: FloatWithAggregatesFilter<"Grocery"> | number
    ProductName?: StringWithAggregatesFilter<"Grocery"> | string
    Quantity?: StringWithAggregatesFilter<"Grocery"> | string
    Stock?: IntWithAggregatesFilter<"Grocery"> | number
    SubCategory?: StringWithAggregatesFilter<"Grocery"> | string
  }
